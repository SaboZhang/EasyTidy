...
public class FileActuator
{
    public static void OnExecuteMoveFile(string source, string target, FileOperationType fileOperationType)
    {
        ...
        {
            LogService.Logger.Error("�ļ��ƶ�ʧ��", ex);
        }
    }
    ...
    public static void OnExecuteCopyFile(string source, string target, FileOperationType fileOperationType)
    {
        ...
        {
            LogService.Logger.Error("�ļ�����ʧ��", ex);
        }
    }
    ...
    public static void ExecuteFileOperation(OperationMode operationMode, string sourcePath, string targetPath, FileOperationType fileOperationType, List<Func<string, bool>> pathFilters = null)
    {
        ...
        {
            // 处理文件夹操作
            ProcessDirectory(sourcePath, targetPath, operationMode, fileOperationType, fileFilters);
        }
        else if (File.Exists(sourcePath))
        {
            // 处理单个文件操作
            ProcessFile(sourcePath, targetPath, operationMode, fileOperationType, fileFilters);
        }
        else
        {
